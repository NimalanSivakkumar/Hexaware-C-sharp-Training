...
namespace AdoAssignment
{
    ...
    public class CustomerServiceProviderImpl
    {
        ...
        public Account FindAccount(long accNo)
        {
            ...
            //var account = accountsset.Find(acc => acc.AccountNumber == accNo);
            ...
            ///if (!accountmap.TryGetValue(AccountNumber, out var account))
            ////    {
            ////        throw new InvalidAccountException("Account not found bro");
        ...
        {
            //var account = accountsset.Find(a => a.AccountNumber == AccountNumber);
